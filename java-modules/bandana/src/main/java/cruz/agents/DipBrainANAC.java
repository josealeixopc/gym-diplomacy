...
import cruz.anacUtils.MyNeuralNetwork;
...
public class DipBrainANAC extends ANACNegotiator {
    /**
    ...
    public static void main(String[] args) {
        ...
        DipBrainANAC myPlayer = new DipBrainANAC(args);
        myPlayer.run();
     ...
     * @param args
     */
    public DipBrainANAC(String[] args) {
        super(args);
