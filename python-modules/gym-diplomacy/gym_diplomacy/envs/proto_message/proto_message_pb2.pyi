...
class DealData(google___protobuf___message___Message):
    class DefendUnitData(google___protobuf___message___Message):
        execute = ... # type: bool
        region = ... # type: int

        def __init__(self,
            execute : typing___Optional[bool] = None,
            region : typing___Optional[int] = None,
            ) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> DealData.DefendUnitData: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"execute",u"region"]) -> None: ...
        else:
            def ClearField(self, field_name: typing_extensions___Literal[b"execute",b"region"]) -> None: ...

    class DefendSCData(google___protobuf___message___Message):
        execute = ... # type: bool
        allyPower = ... # type: int

        def __init__(self,
            execute : typing___Optional[bool] = None,
            allyPower : typing___Optional[int] = None,
            ) -> None: ...
        @classmethod
        def FromString(cls, s: bytes) -> DealData.DefendSCData: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"allyPower",u"execute"]) -> None: ...
        else:
            def ClearField(self, field_name: typing_extensions___Literal[b"allyPower",b"execute"]) -> None: ...

    class AttackRegionData(google___protobuf___message___Message):
        execute = ... # type: bool
        region = ... # type: int
        ...
        @classmethod
        def FromString(cls, s: bytes) -> DealData.AttackRegionData: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"execute",u"region"]) -> None: ...
    ...
    class SupportAttackRegionData(google___protobuf___message___Message):
        execute = ... # type: bool
        region = ... # type: int
        ...
        @classmethod
        def FromString(cls, s: bytes) -> DealData.SupportAttackRegionData: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"execute",u"region"]) -> None: ...
    ...
    phasesFromNow = ... # type: int

    @property
    def defendUnit(self) -> DealData.DefendUnitData: ...

    @property
    def defendSC(self) -> DealData.DefendSCData: ...

    @property
    def attackRegion(self) -> DealData.AttackRegionData: ...

    @property
    def supportAttackRegion(self) -> DealData.SupportAttackRegionData: ...

    def __init__(self,
        defendUnit : typing___Optional[DealData.DefendUnitData] = None,
        defendSC : typing___Optional[DealData.DefendSCData] = None,
        attackRegion : typing___Optional[DealData.AttackRegionData] = None,
        supportAttackRegion : typing___Optional[DealData.SupportAttackRegionData] = None,
        phasesFromNow : typing___Optional[int] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"attackRegion",u"defendSC",u"defendUnit",u"supportAttackRegion"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"attackRegion",u"defendSC",u"defendUnit",u"phasesFromNow",u"supportAttackRegion"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"attackRegion",b"attackRegion",u"defendSC",b"defendSC",u"defendUnit",b"defendUnit",u"supportAttackRegion",b"supportAttackRegion"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"attackRegion",b"defendSC",b"defendUnit",b"phasesFromNow",b"supportAttackRegion"]) -> None: ...
