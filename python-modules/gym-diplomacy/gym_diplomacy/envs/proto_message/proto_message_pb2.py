...
_DEALDATA_DEFENDUNITDATA = _descriptor.Descriptor(
  name='DefendUnitData',
  full_name='dip_q.DealData.DefendUnitData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='execute', full_name='dip_q.DealData.DefendUnitData.execute', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='region', full_name='dip_q.DealData.DefendUnitData.region', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEALDATA_DEFENDSCDATA = _descriptor.Descriptor(
  name='DefendSCData',
  full_name='dip_q.DealData.DefendSCData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='execute', full_name='dip_q.DealData.DefendSCData.execute', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEALDATA_ATTACKREGIONDATA = _descriptor.Descriptor(
  name='AttackRegionData',
  full_name='dip_q.DealData.AttackRegionData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='execute', full_name='dip_q.DealData.AttackRegionData.execute', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='region', full_name='dip_q.DealData.AttackRegionData.region', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEALDATA_SUPPORTATTACKREGIONDATA = _descriptor.Descriptor(
  name='SupportAttackRegionData',
  full_name='dip_q.DealData.SupportAttackRegionData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='execute', full_name='dip_q.DealData.SupportAttackRegionData.execute', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='region', full_name='dip_q.DealData.SupportAttackRegionData.region', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEALDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='defendUnit', full_name='dip_q.DealData.defendUnit', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='defendSC', full_name='dip_q.DealData.defendSC', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='attackRegion', full_name='dip_q.DealData.attackRegion', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='supportAttackRegion', full_name='dip_q.DealData.supportAttackRegion', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='phasesFromNow', full_name='dip_q.DealData.phasesFromNow', index=4,
      number=5, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_DEALDATA_DEFENDUNITDATA, _DEALDATA_DEFENDSCDATA, _DEALDATA_ATTACKREGIONDATA, _DEALDATA_SUPPORTATTACKREGIONDATA, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_DEALDATA_DEFENDUNITDATA.containing_type = _DEALDATA
_DEALDATA_DEFENDSCDATA.containing_type = _DEALDATA
_DEALDATA_ATTACKREGIONDATA.containing_type = _DEALDATA
_DEALDATA_SUPPORTATTACKREGIONDATA.containing_type = _DEALDATA
_DEALDATA.fields_by_name['defendUnit'].message_type = _DEALDATA_DEFENDUNITDATA
_DEALDATA.fields_by_name['defendSC'].message_type = _DEALDATA_DEFENDSCDATA
...
BandanaRequest = _reflection.GeneratedProtocolMessageType('BandanaRequest', (_message.Message,), dict(
  ...
  __module__ = 'gym_diplomacy.envs.proto_message.proto_message_pb2'
...
DealData = _reflection.GeneratedProtocolMessageType('DealData', (_message.Message,), dict(
  ...
  DefendUnitData = _reflection.GeneratedProtocolMessageType('DefendUnitData', (_message.Message,), dict(
    DESCRIPTOR = _DEALDATA_DEFENDUNITDATA,
    __module__ = 'gym_diplomacy.envs.proto_message.proto_message_pb2'
    # @@protoc_insertion_point(class_scope:dip_q.DealData.DefendUnitData)
    ))
  ,

  DefendSCData = _reflection.GeneratedProtocolMessageType('DefendSCData', (_message.Message,), dict(
    DESCRIPTOR = _DEALDATA_DEFENDSCDATA,
    __module__ = 'gym_diplomacy.envs.proto_message.proto_message_pb2'
    # @@protoc_insertion_point(class_scope:dip_q.DealData.DefendSCData)
    ))
  ,

  AttackRegionData = _reflection.GeneratedProtocolMessageType('AttackRegionData', (_message.Message,), dict(
    DESCRIPTOR = _DEALDATA_ATTACKREGIONDATA,
    __module__ = 'gym_diplomacy.envs.proto_message.proto_message_pb2'
    # @@protoc_insertion_point(class_scope:dip_q.DealData.AttackRegionData)
    ))
  ,

  SupportAttackRegionData = _reflection.GeneratedProtocolMessageType('SupportAttackRegionData', (_message.Message,), dict(
    DESCRIPTOR = _DEALDATA_SUPPORTATTACKREGIONDATA,
    __module__ = 'gym_diplomacy.envs.proto_message.proto_message_pb2'
...
_sym_db.RegisterMessage(DealData.DefendUnitData)
_sym_db.RegisterMessage(DealData.DefendSCData)
_sym_db.RegisterMessage(DealData.AttackRegionData)
_sym_db.RegisterMessage(DealData.SupportAttackRegionData)
