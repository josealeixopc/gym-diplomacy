...
class DealData(google___protobuf___message___Message):
    ...
    class DefendSCData(google___protobuf___message___Message):
        ...
        def __init__(self,
            execute : typing___Optional[bool] = None,
            province : typing___Optional[int] = None,
            ) -> None: ...
        @classmethod
        ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
            def ClearField(self, field_name: typing_extensions___Literal[u"execute",u"province"]) -> None: ...
        else:
            def ClearField(self, field_name: typing_extensions___Literal[b"execute",b"province"]) -> None: ...
