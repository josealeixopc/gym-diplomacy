...
class DiplomacyGymOrdersResponse(google___protobuf___message___Message):
    ...
    VALID = typing___cast(Type, 0)
    INVALID = typing___cast(Type, 1)
...
class OrderData(google___protobuf___message___Message):
    actionToPropose = ... # type: int
    startProvince = ... # type: int
    destinationProvince = ... # type: int

    def __init__(self,
        actionToPropose : typing___Optional[int] = None,
        startProvince : typing___Optional[int] = None,
        destinationProvince : typing___Optional[int] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"actionToPropose",u"destinationProvince",u"startProvince"]) -> None: ...
    else:
        def ClearField(self, field_name: typing_extensions___Literal[b"actionToPropose",b"destinationProvince",b"startProvince"]) -> None: ...

class OrdersData(google___protobuf___message___Message):

    @property
    def orders(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[OrdersData]: ...

    def __init__(self,
        orders : typing___Optional[typing___Iterable[OrdersData]] = None,
        ) -> None: ...
    @classmethod
