...
class Command(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"name",u"type"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"data",u"name",u"type"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"name",b"name",u"type",b"type"]) -> bool: ...
...
class ProvinceData(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"owner",u"sc"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"owner",u"sc"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"owner",b"owner",u"sc",b"sc"]) -> bool: ...
