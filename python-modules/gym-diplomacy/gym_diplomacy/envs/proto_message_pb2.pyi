...
class MoveOrder(google___protobuf___message___Message):
    ...
    @property
    def startProvince(self) -> ProvinceData: ...

    @property
    def destinationProvince(self) -> ProvinceData: ...

    def __init__(self,
        startProvince : typing___Optional[ProvinceData] = None,
        destinationProvince : typing___Optional[ProvinceData] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"destinationProvince",u"startProvince"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"destinationProvince",u"startProvince"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"destinationProvince",b"destinationProvince",u"startProvince",b"startProvince"]) -> bool: ...
...
class DealData(google___protobuf___message___Message):
    ...
    @property
    def proposeTo(self) -> PowerData: ...

    def __init__(self,
        oc : typing___Optional[typing___Iterable[OrderCommitment]] = None,
        proposeTo : typing___Optional[PowerData] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"proposeTo"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"oc",u"proposeTo"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"proposeTo",b"proposeTo"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"oc",b"proposeTo"]) -> None: ...
