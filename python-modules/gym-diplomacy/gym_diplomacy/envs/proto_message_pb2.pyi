...
class DealData(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"ourMove",u"phasesFromNow",u"powerToPropose",u"theirMove"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"ourMove",b"ourMove",u"theirMove",b"theirMove"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"ourMove",b"phasesFromNow",b"powerToPropose",b"theirMove"]) -> None: ...
