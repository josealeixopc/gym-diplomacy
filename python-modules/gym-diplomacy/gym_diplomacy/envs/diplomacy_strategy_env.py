...
def action_to_orders_data(action: np.ndarray) -> proto_message_pb2.DealData:
    """
    ...
    for order in action:
        ...
        new_order.actionToPropose = order[0]
        new_order.startProvince = order[1]
...
class DiplomacyStrategyEnv(gym.Env):
    ...
    def _init_action_space(self):
        ...
        self.action_space = spaces.MultiDiscrete([NUMBER_OF_ACTIONS, NUMBER_OF_PROVINCES, NUMBER_OF_PROVINCES])
